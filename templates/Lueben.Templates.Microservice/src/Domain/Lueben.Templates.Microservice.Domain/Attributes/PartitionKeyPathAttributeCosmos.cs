...
namespace Lueben.Templates.Microservice.Domain.Attributes
{
    /// <summary>
    ...
    public class PartitionKeyPathAttributeCosmos : Attribute
    {
        /// <summary>
        ...
        public PartitionKeyPathAttributeCosmos(string path) =>
